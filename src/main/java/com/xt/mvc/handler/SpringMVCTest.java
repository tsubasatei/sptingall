...
public class SpringMVCTest {
    ...
    @ResponseStatus(reason = "测试", code = HttpStatus.NOT_FOUND)
    ...
    public ResponseEntity<byte[]> testResponseEntity(HttpSession session) throws IOException{
        ...
        InputStream in = servletContext.getResourceAsStream("/WEB-INF/file/abc.txt");
    ...
    @PostMapping(value="/testConversionEmployeeConverter")
    ...
    public void getUser(@RequestParam(value = "id", required = false) Integer id, Model model) {
        ...
        if (null != id) {
            //模拟从数据库中获取对象
            User user = new User(1, "Tom", "123456", "tom@163.com", 18);
    ...
    public String testSessionAttributes(Map<String, Object> map) {
        User user = new User("AA", "123456", "AA@163.com", 19);
        map.put("user", user);
    ...
    public String testRequestParam(@RequestParam("username") String un,
        ...
        System.out.println("testRequestParam, usernaem = " + un + ", age = " + age);
        return SUCCESS;
    }
    /**
